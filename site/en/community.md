		...
		<div class="tile is-ancestor">
			<div class="tile is-parent">
				<article class="tile is-child box has-text-alligned">
					<ul>
					<li>
						<strong>OCR-D TechCall</strong> – Take part in our technical discussions about OCR-D tools and issues; every fourth Wednesday in the month, 2 to 3 PM (Berlin Time):
						<a href="https://pad.gwdg.de/75dyxG6gS-e0Q04_fpm-ng">Link&nbsp;to&nbsp;agenda/minutes</a>
					</li>
					<li>
						<strong>OCR-D in der Praxis</strong> – Discuss the practical deployment of OCR-D; every second Friday, 1 to 2 PM (Berlin Time): 
						<a href="https://pad.gwdg.de/LKpSjoJpRcKPvJpUWZsiQQ">Link&nbsp;to&nbsp;agenda/minutes</a>
					</li>
					</ul>
				</article>
			</div>
