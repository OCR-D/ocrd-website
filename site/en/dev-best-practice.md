...
A *fork* is a clone of a GitHub repository hosted on the site. If you fork a repository, a clone of the repository is created under your username. The advantage of a fork over just the original repository is that you have full access to it and can make changes to it to fit your use case. If those changes seem useful to others, you can create a [pull request](#pull-request)
